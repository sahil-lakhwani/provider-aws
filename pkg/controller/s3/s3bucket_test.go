...
// 			ForProvider:  v1beta1.S3BucketParameters{LocalPermission: &perm},
// 		},
// 		Status: S3BucketStatus{
// 			ResourceStatus: runtimev1alpha1.ResourceStatus{},
// 			AtProvider:     v1beta1.S3BucketObservation{IAMUsername: testIAMUsername},
// 		},
// 	}
// }
...
// 	noUserResource.Status.AtProvider.IAMUsername = ""
...
// 	bucketWithPolicyChanges.Spec.ForProvider.LocalPermission = &perm
// 	bucketWithPolicyChanges.Status.AtProvider.LastUserPolicyVersion = 1
// 	bucketWithPolicyChanges.Status.AtProvider.LastLocalPermission = storagev1alpha1.ReadOnlyPermission
...
// 	g := NewGomegaWithT(t)
// 	tr := testResource()
// 	tr.Status.AtProvider.LastUserPolicyVersion = 1
// 	tr.Status.AtProvider.LastLocalPermission = storagev1alpha1.ReadOnlyPermission
...
// 	assertResource(g, r, expectedStatus)
// 	g.Expect(resource.Status.AtProvider.LastUserPolicyVersion).To(Equal(2))
// }
...
// 	tr := testResource()
// 	tr.Status.AtProvider.IAMUsername = ""
...
// 	// test sync
// 	r.connect = func(instance *S3Bucket) (client client.Service, e error) {
// 		instance.Status.AtProvider.IAMUsername = "foo-user"
// 		return nil, nil
// 	}
// 	called = false
// 	r.create = r._create
