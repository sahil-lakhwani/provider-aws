...
type Service interface {
	CreateOrUpdateBucket(bucket *v1beta1.S3Bucket) error
	GetBucketInfo(username string, bucket *v1beta1.S3Bucket) (*Bucket, error)
	CreateUser(username string, bucket *v1beta1.S3Bucket) (*iam.AccessKey, string, error)
	UpdateBucketACL(bucket *v1beta1.S3Bucket) error
	UpdateVersioning(bucket *v1beta1.S3Bucket) error
	UpdatePolicyDocument(username string, bucket *v1beta1.S3Bucket) (string, error)
	DeleteBucket(bucket *v1beta1.S3Bucket) error
}
...
// func (c *Client) CreateOrUpdateBucket(bucket *v1beta1.S3Bucket) error {
...
// func (c *Client) GetBucketInfo(username string, bucket *v1beta1.S3Bucket) (*Bucket, error) {
// 	b := Bucket{}
...
// func (c *Client) CreateUser(username string, bucket *v1beta1.S3Bucket) (*iam.AccessKey, string, error) {
...
// func (c *Client) UpdateBucketACL(bucket *v1beta1.S3Bucket) error {
// 	var err error
// 	name := bucket.GetBucketName()
// 	if bucket.Spec.ForProvider.CannedACL != nil {
// 		input := &s3.PutBucketAclInput{
// 			ACL:    *bucket.Spec.ForProvider.CannedACL,
// 			Bucket: &name,
// 		}
...
// func (c *Client) UpdateVersioning(bucket *v1beta1.S3Bucket) error {
// 	versioningStatus := s3.BucketVersioningStatusSuspended
// 	if bucket.Spec.ForProvider.Versioning {
...
// func (c *Client) UpdatePolicyDocument(username string, bucket *v1beta1.S3Bucket) (string, error) {
// 	policyDocument, err := newPolicyDocument(bucket)
// 	if err != nil {
...
// func (c *Client) DeleteBucket(bucket *v1beta1.S3Bucket) error {
// 	name := bucket.GetBucketName()
...
// 	if bucket.Status.AtProvider.IAMUsername != "" {
// 		err := c.iamClient.DeletePolicyAndDetach(bucket.Status.AtProvider.IAMUsername, bucket.Status.AtProvider.IAMUsername)
// 		if err != nil {
// 			return err
// 		}

// 		return c.iamClient.DeleteUser(bucket.Status.AtProvider.IAMUsername)
// 	}
...
func CreateBucketInput(name string, p *v1beta1.S3BucketParameters) *s3.CreateBucketInput {
...
func GenerateBucketUsername(bucket *v1beta1.S3Bucket) string {
...
func newPolicyDocument(bucket *v1beta1.S3Bucket) (string, error) {
	...
	if bucket.Spec.ForProvider.LocalPermission != nil {
		switch *bucket.Spec.ForProvider.LocalPermission {
		...
		default:
			return "", fmt.Errorf("unknown permission, %s", *bucket.Spec.ForProvider.LocalPermission)
		}
	}
